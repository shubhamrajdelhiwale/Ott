...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-140 bg-black">
      <div className="bg-white shadow-lg rounded-2xl p-11 w-100 text-center border border-gray-200">
        <h2 className="text-2xl font-semibold mb-2">
          Welcome To <span className="text-xl font-bold text-red-600 pr-2">Movie</span>
        ...
        <div className="flex justify-center gap-4 mb-6">
          <button className="p-3 bg-gray-300 rounded-full hover:bg-gray-200">
        ...
        <div className="flex items-center mb-6">
          ...
          <span className="mx-2 text-gray-500 border border-amber-400text-2xl ">OR</span>
